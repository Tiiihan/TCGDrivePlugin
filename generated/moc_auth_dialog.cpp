...
void AuthDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->authCompleted((*reinterpret_cast<std::add_pointer_t<bool>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        case 1: _t->onSignInClicked(); break;
        case 2: _t->onPollTimer(); break;
        case 3: _t->onCancelClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthDialog::*)(bool , QString )>(_a, &AuthDialog::authCompleted, 0))
            return;
    }
}
...
// SIGNAL 0
void AuthDialog::authCompleted(bool _t1, QString _t2)
{
